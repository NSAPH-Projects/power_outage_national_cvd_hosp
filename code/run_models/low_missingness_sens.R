# Do sensitivity analysis with low missingness dataset
...
an_dat <- read_rds(here('data', 'an_dat_urgent_hosp_LOW_MISSINGNESS_SENS.RDS'))
...
ggsave(
  ...
  filename = here(
    'figures_for_upload',
    'supplement',
    'low_missingness_sens_analysis.pdf'
  ),
  width = 14,
  height = 7
)
